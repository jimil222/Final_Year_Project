    ...
    <div className="card hover:border-gray-300 group">
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1 pr-2">
          ...
          <p className="text-gray-600 text-sm mb-2">by <span className="font-medium text-gray-800">{book.author}</span></p>
      ...
      <div className="flex items-center justify-between mt-5 pt-4 border-t border-gray-100">
        ...
        {showRequestButton && (
          <button
            ...
            className={`px-4 py-2 rounded-lg font-semibold text-sm transition-all duration-200 active:scale-[0.98] ${disabled || book.status !== 'available'
