    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-3 mb-2">
          ...
          <h2 className="text-xl md:text-lg font-medium font-['Poppins'] text-gray-600 tracking-tight">
            Scan Inventory
          </h2>
        </div>
          ...
          {scannedBooks.length > 0 && (
            <>
              <button
                ...
                className="px-6 py-3 rounded-lg font-semibold flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white transition-all"
              >
              ...
              <button
                onClick={handleClear}
                className="px-6 py-3 rounded-lg font-semibold bg-gray-300 hover:bg-gray-400 text-gray-800 transition-all"
              >
                Clear All
              </button>
            </>
